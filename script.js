...
// Generate data
const getData = () => [
    { imgSrc: '/img/img1.png', name: 'kotserce'},
    { imgSrc: '/img/img1.png', name: 'kotserce'},
    { imgSrc: '/img/img2.png', name: 'kotplacze'},
    { imgSrc: '/img/img2.png', name: 'kotplacze'},
    { imgSrc: '/img/img3.png', name: 'malpkawow'},
    { imgSrc: '/img/img3.png', name: 'malpkawow'},
    { imgSrc: '/img/img4.png', name: 'niedzwiedz'},
    { imgSrc: '/img/img4.png', name: 'niedzwiedz'},
    { imgSrc: '/img/img5.png', name: 'zaba'},
    { imgSrc: '/img/img5.png', name: 'zaba'},
    { imgSrc: '/img/img6.png', name: 'lama'},
    { imgSrc: '/img/img6.png', name: 'lama'},
    { imgSrc: '/img/img7.png', name: 'tygrys'},
    { imgSrc: '/img/img7.png', name: 'tygrys'},
    { imgSrc: '/img/img8.png', name: 'kotzly'},
    { imgSrc: '/img/img8.png', name: 'kotzly'},
    { imgSrc: '/img/img9.png', name: 'ryba'},
    { imgSrc: '/img/img9.png', name: 'ryba'},
    { imgSrc: '/img/img10.png', name: 'malpkawesola'},
    { imgSrc: '/img/img10.png', name: 'malpkawesola'},
    { imgSrc: '/img/img11.png', name: 'mysz'},
    { imgSrc: '/img/img11.png', name: 'mysz'},
    { imgSrc: '/img/img12.png', name: 'kot'},
    { imgSrc: '/img/img12.png', name: 'kot'},
    { imgSrc: '/img/img13.png', name: 'kotwesoly'},
    { imgSrc: '/img/img13.png', name: 'kotwesoly'},
    { imgSrc: '/img/img14.png', name: 'kosmita'},
    { imgSrc: '/img/img14.png', name: 'kosmita'},
    { imgSrc: '/img/img15.png', name: 'goryl'},
    { imgSrc: '/img/img15.png', name: 'goryl'},
];
